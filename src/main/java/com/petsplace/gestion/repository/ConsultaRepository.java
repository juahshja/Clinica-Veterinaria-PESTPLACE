...
public interface ConsultaRepository extends JpaRepository<Consulta, Long> {
    ...
    @Query("SELECT c FROM Consulta c LEFT JOIN FETCH c.mascota WHERE c.mascota.id = :mascotaId ORDER BY c.fecha DESC")
    ...
    @Query("SELECT c FROM Consulta c LEFT JOIN FETCH c.mascota")
